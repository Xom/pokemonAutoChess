...
const itemsToReplace = new Map([
    ["CHOICE_SCARF", Item_1.Item.LOADED_DICE],
    ["LUCKY_EGG", Item_1.Item.HEAVY_DUTY_BOOTS],
    ["ROTOM_PHONE", Item_1.Item.SPELL_TAG],
    ["FLUFFY_TAIL", Item_1.Item.SAFETY_GOGGLES],
    ["TOXIC_ORB", Item_1.Item.POKERUS_VIAL]
]);
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const itemsStatistics = yield items_statistic_1.ItemsStatistics.find().exec();
