...
function GameStageInfo() {
    ...
    const gameMode = (0, hooks_1.useAppSelector)((state) => state.game.gameMode);
    if (!spectatedPlayer)
        return null;
    ...
    const opponentName = phase === Game_1.GamePhaseState.FIGHT ? spectatedPlayer.opponentName : "";
    const opponentAvatar = phase === Game_1.GamePhaseState.FIGHT ? spectatedPlayer.opponentAvatar : "";
    const opponentTitle = phase === Game_1.GamePhaseState.FIGHT ? spectatedPlayer.opponentTitle : "";
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { id: "game-stage-info", className: "my-container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "stage-information", "data-tooltip-id": "detail-stage", children: [react_dom_1.default.createPortal((0, jsx_runtime_1.jsxs)(react_tooltip_1.Tooltip, { id: "detail-stage", className: "custom-theme-tooltip", place: "bottom", children: [(0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsxs)("span", { className: "help", children: [t("pve_stages"), ":"] }), " ", Object.keys(pve_stages_1.PVEStages).join(", ")] }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsxs)("span", { className: "help", children: [t("carousel_stages"), ":"] }), " ", config_1.ItemCarouselStages.join(", ")] }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsxs)("span", { className: "help", children: [t("additional_picks"), ":"] }), " ", t("stages"), " ", config_1.AdditionalPicksStages.join(t("and"))] }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsxs)("span", { className: "help", children: [t("unique_picks"), ":"] }), " ", t("stages"), " ", config_1.PortalCarouselStages.join(t("and"))] })] }), document.body), (0, jsx_runtime_1.jsxs)("p", { children: [t("stage"), " ", stageLevel] })] }), opponentName === "" && (0, jsx_runtime_1.jsx)(StagePath, {}), (0, jsx_runtime_1.jsxs)("div", { className: (0, jsx_1.cc)("players-information", {
                    ...
                    }), children: [(0, jsx_runtime_1.jsxs)("div", { className: "player-information", children: [(0, jsx_runtime_1.jsx)(pokemon_portrait_1.default, { avatar: avatar }), title && (0, jsx_runtime_1.jsx)("p", { className: "player-title", children: t(`title.${title}`) }), (0, jsx_runtime_1.jsx)("p", { className: "player-name", children: name })] }), opponentName && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { children: "vs" }), (0, jsx_runtime_1.jsxs)("div", { className: "player-information", children: [(0, jsx_runtime_1.jsx)(pokemon_portrait_1.default, { avatar: opponentAvatar }), opponentTitle && ((0, jsx_runtime_1.jsx)("p", { className: "player-title", children: t(`title.${opponentTitle}`) })), (0, jsx_runtime_1.jsx)("p", { className: "player-name", children: isPVE ? t(opponentName) : opponentName })] })] }))] }), spectatedPlayer.map && ((0, jsx_runtime_1.jsxs)("div", { className: "map-information", "data-tooltip-id": "detail-map", children: [react_dom_1.default.createPortal((0, jsx_runtime_1.jsx)(react_tooltip_1.Tooltip, { id: "detail-map", className: "custom-theme-tooltip", place: "bottom", children: (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", alignContent: "center" }, children: [config_1.RegionDetails[spectatedPlayer.map].synergies.map((synergy) => ((0, jsx_runtime_1.jsx)(synergy_icon_1.default, { type: synergy }, "map_type_" + synergy))), (0, jsx_runtime_1.jsx)("p", { children: t(`map.${spectatedPlayer.map}`) })] }) }), document.body), (0, jsx_runtime_1.jsx)("img", { src: `/assets/ui/map.svg` })] })), opponentName != "" && ((0, jsx_runtime_1.jsxs)("div", { className: "weather-information", "data-tooltip-id": "detail-weather", children: [react_dom_1.default.createPortal((0, jsx_runtime_1.jsxs)(react_tooltip_1.Tooltip, { id: "detail-weather", className: "custom-theme-tooltip", place: "bottom", children: [(0, jsx_runtime_1.jsxs)("span", { style: { verticalAlign: "middle" }, children: [(0, jsx_runtime_1.jsx)(synergy_icon_1.default, { type: Weather_1.SynergyAssociatedToWeather.get(weather) }), t(`weather.${weather}`)] }), (0, jsx_runtime_1.jsx)("p", { children: (0, descriptions_1.addIconsToDescription)(t(`weather_description.${weather}`)) })] }), document.body), (0, jsx_runtime_1.jsx)("img", { src: `/assets/icons/weather/${weather.toLowerCase()}.svg` })] })), gameMode && ((0, jsx_runtime_1.jsxs)("div", { className: "game-mode-information", "data-tooltip-id": "detail-game-mode", children: [react_dom_1.default.createPortal((0, jsx_runtime_1.jsxs)(react_tooltip_1.Tooltip, { id: "detail-game-mode", className: "custom-theme-tooltip", place: "bottom", children: [(0, jsx_runtime_1.jsx)("p", { children: t(`game_modes.${gameMode}`) }), (0, jsx_runtime_1.jsx)("p", { children: t(`game_modes_descriptions.${gameMode}`) })] }), document.body), (0, jsx_runtime_1.jsx)(game_mode_icon_1.GameModeIcon, { gameMode: gameMode })] })), (0, jsx_runtime_1.jsx)(game_timer_bar_1.default, {})] }) }));
}
function StagePath() {
    var _a, _b, _c;
    const { t } = (0, react_i18next_1.useTranslation)();
    const spectatedPlayer = (0, hooks_1.useAppSelector)(hooks_1.selectSpectatedPlayer);
    const history = [...((_a = spectatedPlayer === null || spectatedPlayer === void 0 ? void 0 : spectatedPlayer.history) !== null && _a !== void 0 ? _a : [])];
    const phase = (0, hooks_1.useAppSelector)((state) => state.game.phase);
    const stageLevel = (0, hooks_1.useAppSelector)((state) => state.game.stageLevel);
    ...
    while (level < stageLevel + 5) {
        ...
        if (config_1.ItemCarouselStages.includes(level)) {
            ...
            if (level === stageLevel && phase === Game_1.GamePhaseState.TOWN) {
        ...
        if (pveStage) {
            ...
            path.push({
                ...
                icon: (record === null || record === void 0 ? void 0 : record.avatar)
                    ? (0, avatar_1.getAvatarSrc)(record.avatar)
