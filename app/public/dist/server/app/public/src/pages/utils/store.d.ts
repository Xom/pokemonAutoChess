export declare abstract class Store<Key extends string> {
    ...
    has(key: Key): boolean;
    get(key: Key): any;
    put(key: Key, value: any, expirationTimeInSeconds?: number): void;
...
export declare function useLocalStore<T = any>(key: LocalStoreKeys, defaultValue: T, expirationTimeInSeconds?: number): [T, (value: T) => void, () => void];
