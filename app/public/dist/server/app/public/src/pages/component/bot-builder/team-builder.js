...
function TeamBuilder(props) {
    ...
    const inBotBuilder = (0, react_router_1.useLocation)().pathname.startsWith("/bot-builder");
    ...
    function overwriteBoard() {
        var _a;
        (_a = network_1.rooms.game) === null || _a === void 0 ? void 0 : _a.send(types_1.Transfer.OVERWRITE_BOARD, board);
    }
    return ((0, jsx_runtime_1.jsxs)("div", { id: "team-builder", children: [(0, jsx_runtime_1.jsx)("div", { className: "synergies-container my-box", children: (0, jsx_runtime_1.jsx)(synergies_2.default, { synergies: synergies, tooltipPortal: false }) }), (0, jsx_runtime_1.jsxs)("div", { className: "actions", children: [ingame && isAdmin && ((0, jsx_runtime_1.jsxs)("details", { children: [(0, jsx_runtime_1.jsx)("summary", { children: "Admin" }), (0, jsx_runtime_1.jsx)("button", { className: "bubbly blue", onClick: overwriteBoard, children: "Overwrite game board" })] })), ingame && ((0, jsx_runtime_1.jsxs)("button", { className: "bubbly blue", onClick: snapshot, children: [(0, jsx_runtime_1.jsx)("img", { src: "assets/ui/photo.svg" }), " ", t("snapshot")] })), !inBotBuilder && ((0, jsx_runtime_1.jsxs)("button", { className: "bubbly dark", onClick: saveFile, children: [(0, jsx_runtime_1.jsx)("img", { src: "assets/ui/save.svg" }), " ", t("save")] })), !inBotBuilder && ((0, jsx_runtime_1.jsxs)("button", { className: "bubbly dark", onClick: loadFile, children: [(0, jsx_runtime_1.jsx)("img", { src: "assets/ui/load.svg" }), " ", t("load")] })), (0, jsx_runtime_1.jsxs)("button", { className: "bubbly red", onClick: reset, children: [(0, jsx_runtime_1.jsx)("img", { src: "assets/ui/trash.svg" }), " ", t("reset")] })] }), (0, jsx_runtime_1.jsx)(team_editor_1.default, { board: board, handleEditorClick: handleEditorClick, handleDrop: handleDrop, showBench: inBotBuilder }), (0, jsx_runtime_1.jsx)(selected_entity_1.default, { entity: selection, onChange: updateSelectedPokemon }), (0, jsx_runtime_1.jsx)(item_picker_1.default, { selectEntity: setSelection, selected: selection, showUnholdableItems: false }), (0, jsx_runtime_1.jsx)(pokemon_picker_1.default, { selectEntity: (e) => setSelection(e), addEntity: addPokemonOnFirstEmptyCell, selected: selection }), props.bot && props.onChangeAvatar && ((0, jsx_runtime_1.jsx)(bot_avatar_1.default, { bot: props.bot, onChangeAvatar: props.onChangeAvatar, onClick: changeAvatar })), props.error && (0, jsx_runtime_1.jsx)("p", { className: "error", children: props.error })] }));
}
