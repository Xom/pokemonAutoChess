...
function WikiWeather() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { id: "wiki-weather", children: [(0, jsx_runtime_1.jsxs)("div", { className: "my-box", style: { marginBottom: "0.5em" }, children: [(0, jsx_runtime_1.jsx)("p", { children: t("wiki.weather.weather_dominant_hint") }), (0, jsx_runtime_1.jsx)("p", { children: t("wiki.weather.weather_dominant_hint2") })] }), (0, jsx_runtime_1.jsx)("ul", { children: Object.values(Weather_1.Weather).map((weather) => {
                    var _a;
                    return ((0, jsx_runtime_1.jsxs)("li", { className: "my-box", children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsx)("img", { className: "weather-icon", src: `/assets/icons/weather/${weather.toLowerCase()}.svg` }), (0, jsx_runtime_1.jsx)("h2", { children: t(`weather.${weather}`) }), (0, jsx_runtime_1.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [config_1.WeatherThreshold[weather], (0, jsx_runtime_1.jsx)(synergy_icon_1.default, { type: Weather_1.SynergyAssociatedToWeather.get(weather) })] })] }), (0, jsx_runtime_1.jsx)("p", { className: "description", children: (0, descriptions_1.addIconsToDescription)(t(`weather_description.${weather}`)) }), (0, jsx_runtime_1.jsx)("ul", { children: ((_a = pokemonsInfluencingWeather.get(weather)) !== null && _a !== void 0 ? _a : [])
                                    ...
                                    .map((p) => ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)("div", { className: (0, jsx_1.cc)("pokemon-portrait", {
                                            additional: p.additional,
                                            regional: p.regional
                                        }), "data-tooltip-id": "game-pokemon-detail-tooltip", "data-tooltip-content": p.name, children: (0, jsx_runtime_1.jsx)("img", { src: (0, avatar_1.getPortraitSrc)(p.index) }) }, p.name) }, p.index))) })] }, weather));
                }) }), (0, jsx_runtime_1.jsx)(game_pokemon_detail_1.GamePokemonDetailTooltip, { origin: "wiki" })] }));
}
const pokemonsInfluencingWeather = new Map([
    [Weather_1.Weather.ZENITH, [Pokemon_1.Pkm.SHAYMIN_SKY, Pokemon_1.Pkm.CASTFORM_SUN]],
    [
        Weather_1.Weather.DROUGHT,
        [Pokemon_1.Pkm.PRIMAL_GROUDON, Pokemon_1.Pkm.MOLTRES, Pokemon_1.Pkm.SOLROCK, Pokemon_1.Pkm.CASTFORM_SUN]
    ],
    [Weather_1.Weather.NIGHT, [Pokemon_1.Pkm.LUNATONE]],
    [Weather_1.Weather.WINDY, [Pokemon_1.Pkm.LANDORUS, Pokemon_1.Pkm.THUNDURUS, Pokemon_1.Pkm.TORNADUS, Pokemon_1.Pkm.ENAMORUS]],
    [Weather_1.Weather.MISTY, [Pokemon_1.Pkm.ENAMORUS]],
    [Weather_1.Weather.RAIN, [Pokemon_1.Pkm.PRIMAL_KYOGRE, Pokemon_1.Pkm.CASTFORM_RAIN]],
    [Weather_1.Weather.SNOW, [Pokemon_1.Pkm.ARTICUNO, Pokemon_1.Pkm.CASTFORM_HAIL, Pokemon_1.Pkm.TORNADUS]],
    [Weather_1.Weather.STORM, [Pokemon_1.Pkm.ZAPDOS, Pokemon_1.Pkm.THUNDURUS, Pokemon_1.Pkm.PRIMAL_KYOGRE]],
