...
function GameRefresh() {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { className: (0, jsx_1.cc)("bubbly blue refresh-button", {
            shimmer: shopFreeRolls > 0
        }), title: t("refresh_gold_hint"), onClick: () => {
            var _a;
            (_a = (0, game_1.getGameScene)()) === null || _a === void 0 ? void 0 : _a.refreshShop();
        }, children: [(0, jsx_runtime_1.jsx)("img", { src: `/assets/ui/refresh.svg` }), cost === 0 ? (`${t("refresh")} (${shopFreeRolls})`) : ((0, jsx_runtime_1.jsx)(money_1.Money, { value: `${t("refresh")} ${cost}` }))] }));
}
