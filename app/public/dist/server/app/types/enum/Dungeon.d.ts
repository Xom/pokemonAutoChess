export declare enum DungeonMusic {
    ...
    FORTUNE_RAVINE_DEPTHS = "Fortune Ravine Depths",
...
export declare enum DungeonPMDO {
    AmpPlains = "AmpPlains",
...
export declare const DungeonInteger: {
    [key in DungeonPMDO]: number;
};
export declare const DungeonByInteger: {
    [index: string]: DungeonPMDO;
};
export declare const DungeonMusicCredits: {
    [key in DungeonMusic]?: string;
};
