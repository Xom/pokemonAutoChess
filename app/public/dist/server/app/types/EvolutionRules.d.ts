...
export declare enum EvolutionRuleType {
    COUNT = "count",
    ITEM = "item",
    STATE = "state",
    MONEY = "money",
...
export type DivergentEvolution<AdditionalArgs extends any[] = any[]> = (pokemon: IPokemon, player: IPlayer, ...additionalArgs: AdditionalArgs) => Pkm;
...
export type EvolutionRule = CountEvolutionRule | ItemEvolutionRule | StateEvolutionRule | PlacementEvolutionRule | MoneyEvolutionRule | HatchEvolutionRule | StackEvolutionRule;
export {};
