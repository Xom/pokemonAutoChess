...
import type { GameMode, Orientation, PokemonActionState, Rarity, Stat, Team } from "./enum/Game";
...
export declare const CDN_URL = "https://raw.githubusercontent.com/keldaanCommunity/SpriteCollab/master";
export type PkmCustom = {
    shiny?: boolean;
    emotion?: Emotion;
};
...
export interface IPokemonEntity {
    ...
    addAbilityPower(value: number, caster: IPokemonEntity | "environment", apBoost: number, crit: boolean, permanent?: boolean): void;
    ...
    addDodgeChance(value: number, caster: IPokemonEntity | "environment", apBoost: number, crit: boolean): void;
