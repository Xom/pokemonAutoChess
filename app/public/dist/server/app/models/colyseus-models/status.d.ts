...
export default class Status extends Schema implements IStatus {
    ...
    clearAllStatus(entity: PokemonEntity): void;
    clearPositiveStatus(entity: PokemonEntity): void;
    clearNegativeStatus(entity: IPokemonEntity, origin?: IPokemonEntity): void;
    hasNegativeStatus(): boolean;
    transferNegativeStatus(from: PokemonEntity, to: PokemonEntity): void;
    ...
    triggerFreeze(duration: number, pkm: PokemonEntity, origin: PokemonEntity | undefined): void;
    ...
    updateCharm(dt: number, pkm: PokemonEntity): void;
    ...
    triggerRuneProtect(timer: number, pokemon: IPokemonEntity, origin: IPokemonEntity): void;
    ...
    triggerResurrection(pokemon: PokemonEntity, board: Board): void;
    updateResurrecting(dt: number, pokemon: PokemonEntity): void;
    triggerCurse(timer: number, pokemon: PokemonEntity): void;
    ...
    addFairyField(entity: IPokemonEntity): void;
    removeFairyField(entity: IPokemonEntity): void;
    addGrassField(entity: IPokemonEntity): void;
    removeGrassField(entity: IPokemonEntity): void;
}
