...
class AfterGamePlayer extends schema_1.Schema {
    constructor(id, name, avatar, rank, pokemons, title, role, synergies, elo, games, gameStats) {
        super();
        this.pokemons = new schema_1.ArraySchema();
        this.synergies = new schema_1.ArraySchema();
        this.gameStats = new game_stats_1.GameStatsSchema();
        this.id = id;
        this.name = name;
        this.avatar = avatar;
        this.rank = rank;
        ...
        this.elo = elo;
        this.games = games;
        this.gameStats = new game_stats_1.GameStatsSchema(gameStats);
...
__decorate([
    (0, schema_1.type)("uint16")
], AfterGamePlayer.prototype, "games", void 0);
__decorate([
    (0, schema_1.type)("string")
...
], AfterGamePlayer.prototype, "gameStats", void 0);
