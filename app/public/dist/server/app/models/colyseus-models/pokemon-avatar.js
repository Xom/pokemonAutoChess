...
class PokemonAvatarModel extends schema_1.Schema {
    constructor(id, avatar, x, y, timer) {
        ...
        this.targetY = y;
        this.timer = timer;
        const { name, shiny } = (0, avatar_1.getPokemonCustomFromAvatar)(avatar);
        this.name = name;
        this.shiny = shiny !== null && shiny !== void 0 ? shiny : false;
    }
}
...
__decorate([
    (0, schema_1.type)("string")
], PokemonAvatarModel.prototype, "itemId", void 0);
__decorate([
    (0, schema_1.type)("string")
], PokemonAvatarModel.prototype, "portalId", void 0);
