...
export declare function getNbScarvesOnBoard(board: IDetailledPokemon[]): number;
export declare function getNbToolsOnBoard(board: IDetailledPokemon[]): number;
...
export declare function validateBoard(board: IDetailledPokemon[], stage: number, synergies: Map<Synergy, number>): void;
